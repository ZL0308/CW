...
public class Violinist extends Person implements Musician {
  ...
  private Integer instrumentID = 41;

  /**
   * A constructor of Violinist, to initialize the Violinist.
   *
   * @param name        name of Violinist.
   * @param soundSystem SoundSystem of Violinist.
   */
   ...
   * A constructor of Violinist, to initialize the Violinist.
   *
   * @param name the name of Violinist
   * @param soundSystem a SoundSystem
   * @param seat the seat of each musician
   */
