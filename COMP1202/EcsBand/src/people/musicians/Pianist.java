...
public class Pianist extends Person implements Musician {
  ...
  private Integer instrumentID = 1;

  /**
   * A constructor of Pianist, to initialize the Pianist.
   *
   * @param name the name of Pianist.
   * @param soundSystem SoundSystem of Pianist.
   */
