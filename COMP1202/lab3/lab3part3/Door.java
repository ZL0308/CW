...
public class Door {
     ...
     */
    public void openDoor(CardLock lock) {
        boolean isUnlocked;
        ...
        if (this.lock == null) {
            ...
            System.out.println("(the last person to swipe their card was " + this.lock.getLastCardSeen().getOwner() + ")");

            // Ask the lock if the door can be opened.
            isUnlocked = this.lock.isUnlocked();
        }
